        ...
        <ul>
          ...
          <li class= "li_none">
            <DIV>
              ...
              대표 이미지: <A href='${pageContext.request.contextPath}/download2?dir=/contents/storage/main_images&filename=${contentsVO.file1}&downname=${contentsVO.file1}'>${contentsVO.file1}</A>(${contentsVO.size1_label })
              </c:if>  
            </DIV>
